...
const sections: GuideSection[] = [
  ...
  },
  {
    ...
    customerFlow: [
      ...
      {
        label: 'AI 쇼호스트 방송',
        desc: '상품명/가격/상세설명/리뷰요약을 근거로 AI가 만든 판매 대본이 화면에 표시되고, "🔊 방송 듣기"를 누르면 브라우저 음성합성(TTS)으로 읽어줍니다. 접속할 때마다 새로 생성하지 않고 상품당 한 번 만든 대본을 재사용하며, "대본 다시 생성" 버튼으로 언제든 새로 만들 수 있습니다.',
      },
      {
