...
const sections: GuideSection[] = [
  ...
  },
  {
    ...
    inProgress: true,
    summary:
      '상품상세 정보(설명·가격·리뷰요약)를 바탕으로 AI가 판매 대본을 생성하고, 정지 이미지 아바타와 브라우저 음성합성(TTS)으로 읽어주는 온디맨드 방식의 상품 소개 기능입니다. 실제 24시간 라이브 스트리밍이 아니라, 고객이 접속하는 순간 그 자리에서 생성·재생하는 방식이며, 시청 중에는 전용 Q&A로 상품에 대해 물어볼 수 있습니다. 현재 구현 착수 단계로, 완성되면 고객화면·운영자화면 사용법이 채워질 예정입니다.',
    customerFlow: [],
    adminFlow: [],
  },
]
